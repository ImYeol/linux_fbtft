...
static int init_display(struct fbtft_par *par)
{
	...
	printk("init_display from ili9340\n");
...
//	write_reg(par,0x30,0x00,0x00,VEA>>8,VEA&0xFF);
//	write_reg(par,0x12);
	return 0;
}
...
//	printk("gpio wr:%d, rd: %d",par->gpio.wr,par->gpio.rd);
//	val = ILI9340_MADCTL_MV | ILI9340_MADCTL_MY | ILI9340_MADCTL_MX;
//	write_reg(par,0x33,0x00,0x00,VSA>>8,VSA&0xFF,0x00,0x00);
	/* Column address */
...
//	write_reg(par,0x37,VSP>>8,VSP&0xFF);
}
